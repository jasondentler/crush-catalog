...
class TerminalImage:
    ...
    def get_terminal_capability():
        """Detect the best available terminal image rendering mode."""
    ...
    def display(image: Image.Image):
        """Display an image using the current terminal's supported mode."""
    ...
    def _display_pixel(img: Image.Image):
        """Display an image using imgcat-compatible terminal graphics."""
        imgcat(img)

    def _display_kitty(img: Image.Image):
        """Display an image using imgcat's Kitty-compatible path."""
        imgcat(img)

    def _display_ansi(img: Image.Image):
        """Display an image as ANSI color blocks for basic terminals."""
